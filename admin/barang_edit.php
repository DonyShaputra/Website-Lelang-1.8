...
<input type="hidden" name="id" value="<?=$data_barang['id']?>">
  ...
  <label class="form-control-label"  >Nama Barang</label>
                    <input name="nama_barang"  type="text" placeholder="Masukkan Nama Barang" required class="form-control" value="<?=$data_barang['nama_barang']?>"
    name="nama_barang" required>
  </div>
  <div class="form-control-label">
    <label for="exampleInputCity1">Harga Awal</label>
    <input type="number" class="form-control" id="exampleInputCity1" required class="form-control"  value="<?=$data_barang['harga_awal']?>"
    name="harga_awal" required>
  </div>
  <div class="form-control-label">
    <label for="exampleTextarea1" >Deskripsi</label>
    <textarea class="form-control" id="exampleTextarea1" rows="4" required class="form-control" name="deskripsi" 
    required><?=$data_barang['deskripsi_barang']?></textarea>
  </div>
