      ...
      <div class="card card-plain shadow-none" id="sidenavCard">
        ...
        <div class="card-body text-center p-3 w-100 pt-0">
          <div class="docs-info">
           ...
           <a href="petugas_tambah.php" class="btn btn-dark btn-sm w-100 mb-3">Tambah Petugas</a>
      </div>
  </aside>
      ...
      <div class="row">
        <div >
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-uppercase text-sm">Hapus Data Petugas</p>
              <div class="row">
                  <form method="POST">
                                   ...
                                   include("koneksi.php");
$id      = $_GET['id'];
$tampil = mysqli_query($koneksi, "SELECT * FROM petugas WHERE id='$id'");
...
?>
  ...
  <h6>Yakin Akan Menghapus Data Petugas <b><?php echo $data['nama_petugas'] ?></b> ?</h6>
    ...
    if(isset($_POST['hapus'])){ //proses hapus data barang
      ...
      $ubah = mysqli_query($koneksi, 'DELETE FROM petugas WHERE id="'.$id.'"');
        if ($ubah){
        echo '
        <script>
        alert("Berhasil Menghapus Data Petugas");
        window.location="petugas.php"; //menuju ke halaman barang
        </script>
        ';
      }
    }
