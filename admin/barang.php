                  ...
                  <?php
                            ...
                            while ($data = mysqli_fetch_array($tampil)) {
                                ...
                                <td>
                                    <?php
                                    echo '
                                <a href="barang_edit.php?&id=' . $data['id'] . '" class="btn btn-warning btn-sm"> <i class="fa fa-pencil fa-fw"></i> Edit</a>
                                <a href="barang_hapus.php?&id=' . $data['id'] . '" class="btn btn-danger btn-sm"> <i class="fa fa-trash fa-fw"></i> Hapus</a>
