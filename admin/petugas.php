            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <?php
							  include('koneksi.php');
                                $tampil = mysqli_query($conn,"SELECT * FROM petugas");
                            while ($data = mysqli_fetch_array($tampil)) {
                                ...
                                <td class="mb-0 text-sm"><?php echo $data['nama_petugas']; ?></p></td>
                                <td class="mb-0 text-sm"><?php echo $data['username']; ?></td>
                                <td class="mb-0 text-sm"><?php echo $data['level']; ?></td>
                                <td>
                                    <?php
                                    echo '
                                <a href="petugas_edit.php?&id=' . $data['id'] . '" class="btn btn-warning btn-sm"> <i class="fa fa-pencil fa-fw"></i> Edit</a>
                                <a href="petugas_hapus.php?&id=' . $data['id'] . '" class="btn btn-danger btn-sm"> <i class="fa fa-trash fa-fw"></i> Hapus</a>
